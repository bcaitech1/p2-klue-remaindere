...
def train(args):
  ...
  # #model = ElectraModel.from_pretrained("monologg/koelectra-base-v3-discriminator", config = bert_config)
...
if __name__ == '__main__':
  ...
  parser.add_argument('--output_dir', required=True, default="/opt/ml/results")
  parser.add_argument('--save_total_limit', required=False, type=int, default=4)
  parser.add_argument('--save_steps', required=False, type=int, default=500)
  parser.add_argument('--num_train_epochs', required=True, type=int, default=5)
  ...
  parser.add_argument('--logging_dir', required=False, default="/opt/ml/logs")
