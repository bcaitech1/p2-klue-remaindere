...
def main(args):
  ...
  # use list comprehension to flatten list
  pred_answer = [pred_val for single_array in pred_answer for pred_val in single_array]
  # make csv file with predicted answer
  # 아래 directory와 columns의 형태는 지켜주시기 바랍니다.

  output = pd.DataFrame(pred_answer, columns=['pred'])
  output.to_csv(args.pred_dir, index=False)
...
if __name__ == '__main__':
  ...
  parser.add_argument('--pred_dir', type=str, default="../results/checkpoint-500/pred.csv")
